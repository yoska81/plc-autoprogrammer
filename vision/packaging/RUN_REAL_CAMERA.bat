...
rem Double-click PROBE_CAMERAS.bat first, or use Camera Setup - Detect
rem Cameras inside the app, to see which index is available.
set DEVICE_INDEX=0
...
if errorlevel 1 (
    ...
    echo     Camera Setup - Detect Cameras inside the app.
